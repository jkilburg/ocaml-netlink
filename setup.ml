...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4804f4e15381de113f2a13aac232ae44) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "netlink"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "genintf.ml"});
               Test
                 ({
                     cs_name = "lib_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "K\144\004\183\212\198\182\1357\148\174v\209\216\168\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
